...
class OnePairEvaluatorTest {
    ...
    private OnePairEvaluator evaluator;
    ...
    void testEvaluate_FindsPair() {
        ...
        // Then
        assertTrue(result);
        assertEquals(2, evaluator.getPosition().size());
        assertEquals(new Card(ACE, DIAMONDS), evaluator.getPosition().get(0));
        assertEquals(new Card(ACE, HEARTS), evaluator.getPosition().get(1));
    }

    @Test
    void testEvaluate_NoPair() {
        // Given
        List<Card> hand = new ArrayList<>(List.of(
                new Card(ACE, HEARTS),
    ...
    @Test
    void testGetLayout_ReturnsPair() {
        // Given
        List<Card> hand = new ArrayList<>(List.of(
                new Card(ACE, HEARTS),
                new Card(ACE, DIAMONDS),
        ...
        // Then
        assertEquals(HandEvaluator.Layouts.PAIR, evaluator.getLayout());
    }

    @Test
    void testEvaluate_MultiplePairs_FindsFirstPair() {
        // Given
        List<Card> hand = new ArrayList<>(List.of(
                new Card(ACE, HEARTS),
                new Card(ACE, DIAMONDS),
